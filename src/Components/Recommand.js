...
export default function Recommand() {
  const data = [
    ...
    },
    {
      image: Destination2,
      title: "Thailand",
      subTitle: "Thailand is a Southeast Asia country. Its know for",
      cost: "54.200",
      duration: "Approx 2 night trip",
    },
    {
    ...
    },
    {
      image: Destination4,
      title: "New Zealand",
      subTitle: "New Zealand is an iland country in the",
      cost: "24.100",
...
const Section = styled.section`
  ...
  .packages {
    ...
    ul {
      ...
      .active {
        border-bottom: 0.5rem solid #4468e2;
      }
    }
  }
  .destinations {
